...
public interface PhrServiceDefault {

    @RequestMapping(value = "/patients/{patientId}/profile", method = RequestMethod.GET, headers = TokenRelayTypeHeader.DEFAULT_HEADER_VALUE)
